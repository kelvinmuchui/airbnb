...
export default function Home({ exploreData, cardData }) {
  return (
    <div className="bg-gray-200">
      ...
      <Branner/>
      {/*  */}
      <main className="max-w-7xl mx-auto px-8 py-3 sm:px-16">
        <section className= " shadow-xl rounded-xl bg-white pt-4">
        ...
        <section className = "shadow-xl mt-3 rounded-xl bg-white">
