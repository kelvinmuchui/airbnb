        ...
        '>
            ...
            <div className ="flex 
             ...
             ">
                ...
                <SearchIcon className = " animate-pulse hidden md:inline-flex h-8 bg-red-400 text-white rounded-full p-2 cursor-pointer md:mx-2"/>
            </div>
            {/* Right */}
                ...
                <DateRangePicker
                 ...
                 <div className="flex items-center border-b mb-4">
                     ...
                     <UserIcon 
                        className= "h-5"
                     />
                     <input className="w-12 pl-2 text-lg 
